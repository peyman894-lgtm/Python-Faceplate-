...
class Faceplate(QWidget):
    ...
    def __init__(self, tag_name, manager):
        super().__init__()
    ...
    def closeEvent(self, event):
        ...
        if self.tag_name in self.manager.faceplates:
            del self.manager.faceplates[self.tag_name]
...
class FaceplateManager:
    ...
    def check_indicator(self):
        ...
        if tag_name in self.faceplates:
            ...
            self.faceplates[tag_name].popup()

            return

        print("Opening:", tag_name)
